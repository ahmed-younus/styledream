        ...
        <div class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div class="bg-background rounded-2xl p-6 max-w-md w-full">
                ...
                <div class="grid grid-cols-4 gap-3">
                    ...
                    <a wire:click="trackShare('whatsapp')" href="https://wa.me/?text=Check%20out%20my%20outfit%20on%20Stylely!" target="_blank" class="flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-secondary transition-colors cursor-pointer">
