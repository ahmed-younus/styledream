                    ...
                    <div class="bg-secondary rounded-xl overflow-hidden group relative">
                        ...
                        <div class="aspect-square overflow-hidden relative">
                            ...
                            <div class="absolute top-2 right-2 flex gap-1.5 md:hidden">
                                ...
                                <button wire:click="deleteItem({{ $item->id }})" wire:confirm="{{ __('wardrobe.delete_confirm') }}" class="p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-sm active:scale-95 transition-transform">
