...
return [
    ...
    'section2_li4' => 'Style feed and community features',

    // Section 3: User Accounts
    'section3_title' => 'User Accounts & Registration',
    'section3_p1' => 'To access certain features of the Service, you must create an account. You agree to provide accurate, current, and complete information during registration and to update such information to keep it accurate, current, and complete.',
    'section3_p2' => 'You are responsible for safeguarding your account credentials and for all activities that occur under your account. You must notify us immediately of any unauthorized use of your account or any other breach of security.',
    ...
    'section7_title' => 'Refund Policy',
    'section7_p1' => 'Due to the digital nature of our Service, all credit purchases are final and non-refundable once credits have been used. However, we may consider refund requests on a case-by-case basis for unused credits within 14 days of purchase.',
    'section7_p2' => 'If you experience technical issues that result in loss of credits, please contact our support team, and we will investigate and provide appropriate remediation.',

    // Section 8: Prohibited Conduct
    'section8_title' => 'Prohibited User Conduct',
    'section8_p1' => 'You agree not to engage in any of the following prohibited activities:',
    'section8_li1' => 'Uploading images containing nudity, explicit content, or inappropriate material',
    'section8_li2' => 'Uploading images of minors without parental consent',
    'section8_li3' => 'Using the Service to harass, abuse, or harm others',
    'section8_li4' => 'Attempting to reverse engineer, decompile, or hack the Service',
    'section8_li5' => 'Using automated systems, bots, or scripts to access the Service',
    'section8_li6' => 'Violating any applicable laws, regulations, or third-party rights',
    ...
    'section10_title' => 'Third-Party Services',
    'section10_p1' => 'Our Service integrates with third-party services that are subject to their own terms and privacy policies:',
    'section10_li1' => 'Google AI - For image processing and AI generation',
    'section10_li2' => 'Stripe - For payment processing',

    // Section 11: Disclaimer of Warranties
    'section11_title' => 'Disclaimer of Warranties',
    'section11_p1' => 'THE SERVICE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.',
    'section11_p2' => 'We do not warrant that the Service will be uninterrupted, error-free, secure, or free of viruses or other harmful components.',
    ...
    'section14_p1' => 'We may terminate or suspend your account and access to the Service immediately, without prior notice or liability, for any reason, including if you breach these Terms.',
    'section14_p2' => 'Upon termination, your right to use the Service will immediately cease. Any unused credits in your account may be forfeited upon termination for cause.',
    ...
    'section16_p1' => 'Before filing a claim, you agree to try to resolve the dispute informally by contacting us. We will try to resolve the dispute informally within 30 days.',
    'section16_p2' => 'If the dispute is not resolved within 30 days, either party may pursue formal dispute resolution. Any legal proceedings shall be conducted in English.',

    // Section 17: Changes to Terms
    'section17_title' => 'Changes to Terms',
    'section17_p1' => 'We reserve the right to modify these Terms at any time. We will provide notice of material changes by posting the updated Terms on the Service and updating the "Last Updated" date. Your continued use of the Service after changes are posted constitutes acceptance of the modified Terms.',

    // Section 18: Contact
    'section18_title' => 'Contact Information',
    'section18_p1' => 'If you have any questions about these Terms, please contact us:',
];
